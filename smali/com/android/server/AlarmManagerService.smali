...
.method public firstWakelockAcquired(J)V
    .locals 5
    .parameter "sinceWakelockAcquired"
...
.method public setRepeating(IJJLandroid/app/PendingIntent;)V
    ...
    invoke-static {v11, v12, v5, v6, v7}, Landroid/util/TimeUtils;->formatDuration(JJLjava/io/PrintWriter;)V
    ...
    const-string v12, "[FXN.ASD]setRepeating "
    ...
    iget v12, v2, Lcom/android/server/AlarmManagerService$Alarm;->type:I

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v11

    const-string v12, " trigger on=("
    ...
    .line 276
    .end local v5           #now:J
    .end local v7           #prt:Ljava/io/PrintWriter;
    .end local v8           #s:Ljava/io/StringWriter;
    :goto_2
    :try_start_2
    ...
    .restart local v7       #prt:Ljava/io/PrintWriter;
    .restart local v8       #s:Ljava/io/StringWriter;
    :cond_2
    :try_start_3
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J
    :try_end_3
    ...
    const-string v12, "[FXN.ASD] Exception "
    ...
    const-string v12, " happened when dumping alarms info. Ignore since it is harmless to system."
